...
//Mensajes para el MESH. Todos los mensajes estan armados para ser concatenados a la mac. 
	...
	/** formato base <strong>|S|F</strong><br>F es timestamp formato ddMMyyHHmmss.
	 * <br><strong>Ej: "{mac}|S|091018145050"</strong>*/ 
	public static final String MESH_STATUS = "|S|%s\n";
	
	/** formato base <strong>|S|F</strong><br>F es timestamp formato ddMMyyHHmmss.
	 * <br><strong>Ej: "{mac}|O|091018145050"</strong>*/ 
	public static final String MESH_STATUS_O = "|O|%s\n";
